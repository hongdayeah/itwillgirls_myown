...
public class ProgramDAO {
	...
	public List<ProgramDTO> list(String pro_obj){
		List<ProgramDTO> list = null;
		try {
			sql = new StringBuilder();
			
			sql.append(" SELECT pro_obj, pro_name, prochar_no, pro_limit, pro_fee, prorec_start, prorec_end, proper_start, proper_end, pro_day, pro_age, pro_exp, pro_poster, pro_img, pro_imgsize, pro_regdate, pro_readcnt FROM program_info ");
			...
			RowMapper<ProgramDTO> rowMapper = new RowMapper<ProgramDTO>() {
				...
				public ProgramDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					dto.setPro_imgsize(rs.getInt("pro_imgsize"));
