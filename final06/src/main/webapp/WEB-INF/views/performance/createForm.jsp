...
<%@ include file="../header.jsp" %>
	...
	<form name='percreate' method='POST' action="create.do" enctype="multipart/form-data">
	    ...
	    <table>
	        ...
	        <tr>
	          <th>공연설명</th>
	          <td><textarea rows="5" cols="50"></textarea></textarea></td>
	        </tr>
	        <tr>
	          <th>상영날짜</th>
	          <td><input type='date' name='date' min="2020-01-01" max="2029-12-31"></td>
	        </tr>
	        <tr>
	          <th>상영시간</th>
	        ...
	        <tr>
	          <th>정원</th>
	          <td><input type='text' name='limit' size='20'></td>
	        </tr>
	        <tr>
	          <th>장소</th>
	          <td>
	          <input type='radio' name='class' value="theater" checked="checked">극장
	          <input type='radio' name='class' value="outdoor">야외  
	          </td>
	        </tr>
	        <tr>
	          <th>포스터</th>
