...
<div class="content">
	...
	<form action="join.do" method="post" onsubmit="return send()">
		...
		<div class="agreeCon" tabindex="0">
			<div>
				도담도담어린이문화센터 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. </br> 본 약관은 다양한 도담도담어린이문화센터
				서비스의 이용과 관련하여 도담도담어린이문화센터 서비스를 제공하는 도담도담어린이문화센터(이하 ‘센터’)와 이를 이용하는
				...
				있도록 약관 및 운영정책을 게시하며 사전 공지 후 개정합니다.</br> </br> 도담도담어린이문화센터는 본 약관의 내용을 여러분이 쉽게
				확인할 수 있도록 서비스 예약결제 화면에 게시하고 있습니다.</br> 도담도담어린이문화센터는 수시로 본 약관, 계정 및 게시물
				...
				도담도담어린이문화센터는 변경된 약관을 게시한 날로부터 효력이 발생되는 날까지 약관 변경에 대한 여러분의 의견을 기다립니다.</br>
				위 기간이 지나도록 여러분의 의견이 도담도담어린이문화센터에 접수되지 않으면, 여러분이 변경된 약관에 따라 서비스를 이용하는
				데에 동의하는 것으로 간주됩니다.</br> 도담도담어린이문화센터로서는 매우 안타까운 일이지만, 여러분이 변경된 약관에 동의하지 않는
				경우 변경된 약관의 적용을 받는 해당 서비스의 제공이 더 이상 불가능하게 될 수 있습니다.</br> </br> 도담도담어린이문화센터 서비스에는
				...
				초기 화면에서 확인해 주시기 바랍니다.</br> </br> 본 약관은 한국어를 정본으로 합니다. 본 약관 또는 도담도담어린이문화센터 서비스와
				관련된 여러분과 도담도담어린이문화센터와의 관계에는 대한민국의 법령이 적용됩니다.</br> 그리고 본 약관 또는 도담도담어린이문화센터
		...
		<div class="agreeCon" tabindex="0">
			<div>
				...
				도담도담어린이문화센터가 이용자로부터 수집하는 개인정보는 아래와 같습니다.<br /> - 예약결제 및 예매확인 시에 ‘이름,
				휴대전화번호, 이메일 주소’를 필수항목으로 수집합니다.<br /> 서비스 이용 과정에서 이용자로부터 수집하는 개인정보는
				아래와 같습니다.<br /> 도담도담어린이문화센터 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당
				...
				서비스 요소의 발굴 및 기존 서비스 개선 등을 위하여 개인정보를 이용합니다.<br /> 법령 및 도담도담어린이문화센터
				...
				<br /> 3. 개인정보의 파기<br /> 도담도담어린이문화센터는 원칙적으로 이용자의 개인정보를 예약결제 건 현장 발권
				...
				경우는 아래와 같습니다. <br /> 도담도담어린이문화센터는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본
