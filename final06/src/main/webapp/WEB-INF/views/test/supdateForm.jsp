...
<div class="registration-bgtest">
	<div class="container">
		<form class="form-signintest wow fadeInUp" method="POST" action="supdate.do">
			<input type="hidden" name="stest_no" id="stest_no" value="${dto.stest_no}">
			<h2 class="form-signin-headingtest">[1부] 질문 수정</h2>
			<div class="login-wraptest">
				<input type="text" class="form-control" name="stest_name" id="stest_name" placeholder="${dto.stest_name}" autofocus>
