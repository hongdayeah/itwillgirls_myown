                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                ...
                                <a class="dropdown-item" onclick="location.href='#'">어린이 성향이란?</a>
                                <a class="dropdown-item" onclick="location.href='#'">성향테스트하기</a>
                            </div>
                        </div>
                        <a onclick="location.href='/performance/list.do'" class="nav-item nav-link">공연</a>
                        <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                <a class="dropdown-item" onclick="location.href='#'">공지사항</a>
                    ...
                    <div class="ms-auto d-none d-lg-block">
						...
						<!-- Button trigger modal -->
                        	<a class="btn btn-primary rounded-pill py-2 px-3" data-toggle="modal" data-target="#login" onclick="openLoginModal()">로그인</a>
							<!-- Modal -->
