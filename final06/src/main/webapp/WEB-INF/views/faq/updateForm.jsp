	...
	<div class="bs-docs-section mar-b-30"><br><br>
		<div class="bs-programform">
			<form role="form" name="faqfrm" id="faqfrm"  method="POST" action="create.do" onsubmit="return faqCheck()">
				...
				<div class="form-group">
					<label>제목</label><br>
					<input type="text" class="form-control short" value="${dto.f_question}" name="f_question" id="f_question" required>
				</div>
			<div class="form-group">
			  <label for="f_answer">답변</label><br>
			  <textarea class="form-control" name="f_answer" id="f_answer" rows="10" required>${dto.f_answer}</textarea>
			</div>	
