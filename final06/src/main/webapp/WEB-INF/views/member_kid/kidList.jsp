...
<div class="login-bg">
	<div class="container">
		<div class="form-wrapper">
			<input type="button" onclick="location.href='/member_kid/addKid.do'"
				value="자녀 회원 등록">
			<form class="form-signin wow fadeInUp" name="addKidfrm"
				id="addKidfrm" method="post" onsubmit="return addCheck()">
					...
					<table>
						...
						<c:forEach var="kid_dto" items="${list}">
							<tr>
								...
								<td>${kid_dto.k_gender}</td>
								<td>${kid_dto.typename}</td>
								<td>
									<input type="button" value="수정" onclick="location.href='update.do?p_id=${member_dto.p_id}'"> <!-- 임시 경로 -->
									<input type="button" value="삭제" onclick="location.href='delete.do?p_id=${member_dto.p_id}'"> <!-- 임시 경로 -->
								</td>
							</tr>
						</c:forEach>
					</table>
